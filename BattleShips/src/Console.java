...
//            if (!listUser.checknameIDUserFromList(user.getNameID())) break;
...
//                if (nameID.equals("0")) {
//                    break;
//                } else if (listUser.checknameIDUserFromList(nameID)) {
...
//                        if (numGold >= 0) {
//                            listUser.addUserGoldByNameIDToList(nameID, numGold);
...
//                        numGold = Double.parseDouble(sc.nextLine());
//                        if (numGold >= 0) {
//                            listUser.subUserGoldByNameIDToList(nameID, numGold);
...
//                        if (numDiamond >= 0) {
//                            listUser.addUserDiamondByNameIDToList(nameID, numDiamond);
...
//                        numDiamond = Double.parseDouble(sc.nextLine());
//                        if (numDiamond >= 0) {
//                            listUser.subUserDiamondByNameIDToList(nameID, numDiamond);
...
//                        numGold = Double.parseDouble(sc.nextLine());
//                        if (numGold >= 0) {
//                            listUser.setUserGoldByNameIDToList(nameID, numGold);
...
//                        numDiamond = Double.parseDouble(sc.nextLine());
//                        if (numDiamond >= 0) {
//                            listUser.setUserDiamondByNameIDToList(nameID, numDiamond);
